...
Number of occurence of a specific module      |      In this last part, you can specify the probability *p<sub>j</sub>* of the module of interest *j* together with a particular sample size *t*, to calculate a curve showing the probability for a module to occur *k* times (in function of *k*).   
